...
namespace QuanLyNhanVien.MVVM.View.SubView
{
    ...
    public partial class QLThuViecThoiViecView : UserControl
    {
        ...
        private void suaNhanVienBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _ = new MessageBoxCustom("Vui lòng chọn nhân viên cần sửa!", MessageType.Warning, MessageButtons.Ok).ShowDialog();
                return;
            }
        ...
        private void xoaBtn_Click(object sender, RoutedEventArgs e)
        {
            if (thuViecDtg.SelectedItems.Count == 0)
            {
                _ = new MessageBoxCustom("Vui lòng chọn nhân viên cần xóa!", MessageType.Warning, MessageButtons.Ok).ShowDialog();
                return;
            }
            ...
            DataGridLoad();
            _ = new MessageBoxCustom("Xóa nhân viên thành công!", MessageType.Success, MessageButtons.Ok).ShowDialog();
        }
        ...
        public void XemChiTiet()
        {
            if (thuViecDtg.SelectedItems.Count == 0)
            {
                _ = new MessageBoxCustom("Vui lòng chọn nhân viên cần xem!", MessageType.Warning, MessageButtons.Ok).ShowDialog();
                return;
            }
